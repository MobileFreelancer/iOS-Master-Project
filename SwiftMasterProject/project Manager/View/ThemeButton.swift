...
class ThemeButton : UIButton {
    ...
    func sharedInit(sTitle: String = "", bgColor: UIColor? = .white, txColor: UIColor? = .blue, fontSize : CGFloat = 20.0, fontStyle: MainFont = .bold, cornerradius: CGFloat = 22.0, borderWidht: CGFloat = 1.0,withOnlyBorder:Bool = false) {
